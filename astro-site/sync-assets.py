...
the brief, and — for the icons — whether the PNG actually has an alpha
channel. An opaque icon renders as a solid block on a dark tile, and that is
not obvious until the page is in front of you.
"""
...
FLOWS = [
    ...
    {"name": "tile icons",
     ...
     "ext": ".png", "alpha": True, "recurse": False},
]
